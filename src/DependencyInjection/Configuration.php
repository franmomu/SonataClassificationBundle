        ...
        $rootNode
            ->children()
                ->arrayNode('class')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('tag')->defaultValue('App\\Entity\\Tag')->end()
                        ->scalarNode('category')->defaultValue('App\\Entity\\Category')->end()
                        ->scalarNode('collection')->defaultValue('App\\Entity\\Collection')->end()
                        ->scalarNode('context')->defaultValue('App\\Entity\\Context')->end()
